...
- **美颜**：磨皮、美白（GPUPixel WASM，Apache-2.0，本地 GPU 处理）、瘦脸、大眼（face-api.js MIT 人脸检测 + 自研液化算法，纯本地）
- **一键工具**：一键提亮（自动曝光）、一键打印、相框、抠图（背景色移除）、插画特效（13 种：素描/油画/马赛克/像素化/复古/黑白/反色/柔焦/锐化/浮雕/水墨/暖调/冷调）
- **装饰与文字**：13 款内置贴纸（星星/爱心/皇冠/彩虹等）、8 种文字特效（霓虹/鎏金/渐变/投影/描边/漫画/柔光）
