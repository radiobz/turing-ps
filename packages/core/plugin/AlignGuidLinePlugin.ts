    ...
    canvas.on('object:moving', (e) => {
      ...
      for (let i = canvasObjects.length; i--; ) {
        ...
        if (isInRange(objectLeft - objectWidth / 2, activeObjectLeft - activeObjectWidth / 2)) {
          ...
          const x = objectLeft - objectWidth / 2 + activeObjectWidth / 2;
          const y = reachTop ? _elReachTop : activeObjectTop;
        ...
        if (isInRange(objectTop - objectHeight / 2, activeObjectTop - activeObjectHeight / 2)) {
          ...
          const x = reachLeft ? _elReachLeft : activeObjectLeft;
          const y = objectTop - objectHeight / 2 + activeObjectHeight / 2;
          activeObject.setPositionByOrigin(new fabric.Point(x, y), 'center', 'center');
        }
